...
import static com.cgdpd.library.catalog.api.BookCopyEntityTestData.CHRIS_DANE__ONCE_AGAIN_COPY_1;
import static com.cgdpd.library.catalog.api.BookCopyEntityTestData.CHRIS_DANE__ONCE_AGAIN_COPY_2;
import static com.cgdpd.library.catalog.api.BookCopyEntityTestData.COLUMBUS_CHRISTOPHER__IN_LOVE_COPY_1;
import static com.cgdpd.library.catalog.api.BookCopyEntityTestData.COLUMBUS_CHRISTOPHER__IN_LOVE_COPY_2;
import static com.cgdpd.library.catalog.api.BookCopyEntityTestData.COLUMBUS_CHRISTOPHER__IN_LOVE_COPY_3;
import static com.cgdpd.library.catalog.api.BookCopyEntityTestData.JANE_DANE__KILLER_COPY_1;
import static com.cgdpd.library.catalog.api.BookCopyEntityTestData.JANE_DANE__KILLER_COPY_2;
import static com.cgdpd.library.catalog.api.BookCopyEntityTestData.JANE_DANE__SURVIVOR_COPY_1;
import static com.cgdpd.library.catalog.api.BookCopyEntityTestData.JOHN_DOE__FINDER_COPY_1;
import static com.cgdpd.library.catalog.api.BookCopyEntityTestData.JOHN_DOE__FINDER_COPY_2;
import static com.cgdpd.library.catalog.api.BookCopyEntityTestData.JOHN_DOE__THE_ADVENTUROUS_COPY_1;
import static com.cgdpd.library.catalog.api.BookCopyEntityTestData.JOHN_DOE__THE_ADVENTUROUS_COPY_2;
